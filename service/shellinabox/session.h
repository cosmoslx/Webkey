...
struct Session {
  ...
  /*Server*/void           *server;
  /*ServerConnection*/void *connection;
  const char       *peerName;
  /*HttpConnection*/void   *http;
  /*URL*/void              *url;
  int              done;
  int              pty;
  int              width;
...
void initSession(struct Session *session, const char *sessionKey,
                 /*Server*/void *server, /*URL*/ void *url, const char *peerName);
struct Session *newSession(const char *sessionKey, /*Server*/void *server, /*URL*/void *url,
                           const char *peerName);
...
struct Session *findCGISession(int *isNew, /*HttpConnection*/void *http, /*URL*/void *url,
                               const char *cgiSessionKey);
struct Session *findSession(int *isNew, /*HttpConnection*/void *http, /*URL*/void *url);
